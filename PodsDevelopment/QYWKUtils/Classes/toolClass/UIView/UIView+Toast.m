...
static const CGFloat CSToastShadowRadius        = 0;
static const CGSize  CSToastShadowOffset        = { 0, 0 };
...
- (void)makeCenterWhiteToastWithString:(NSString *)string{
