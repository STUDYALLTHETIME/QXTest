...
@interface BSPushListScrollView ()
@property (strong, nonatomic) UIPanGestureRecognizer *panGr;
@end
@implementation BSPushListScrollView
...
- (void)setEdgePop{
    id target = self.vc.navigationController.interactivePopGestureRecognizer.delegate;
